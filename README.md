...
```bash
# macOS (Apple Silicon)
curl -L https://github.com/pders01/mdv/releases/latest/download/mdv-darwin-arm64.tar.gz | tar xz
sudo mv mdv-darwin-arm64 /usr/local/bin/mdv

# macOS (Intel)
curl -L https://github.com/pders01/mdv/releases/latest/download/mdv-darwin-x64.tar.gz | tar xz
sudo mv mdv-darwin-x64 /usr/local/bin/mdv

# Linux (x64)
curl -L https://github.com/pders01/mdv/releases/latest/download/mdv-linux-x64.tar.gz | tar xz
sudo mv mdv-linux-x64 /usr/local/bin/mdv

# Linux (ARM64)
curl -L https://github.com/pders01/mdv/releases/latest/download/mdv-linux-arm64.tar.gz | tar xz
sudo mv mdv-linux-arm64 /usr/local/bin/mdv
```
